...
// int sbl_text_modulace(EDIT_MATERIAL *p_mat, 
//                       EDIT_STATE_TEXT_BLOK *p_stage, 
...
{  
  ...
  p_vertex_normal = (p_mesh->p_data->m2flag&(MAT2_CALC_MAP1|MAT2_CALC_MAP2|MAT2_CALC_MAP3|MAT2_CALC_MAP4)) ? p_mesh->p_vertex_norm : NULL;
...
{  
  ...
  p_vertex_pos = p_mesh->p_vertex_pos;
  p_vertex_normal = p_mesh->p_data->m2flag&MAT2_CALC_MAP1 ? p_mesh->p_vertex_norm : NULL;
...
void ber_kresli_poly_vertex_multitext_specular(EDIT_MESH_POLY *p_poly, EDIT_MATERIAL **p_mat)
{
  ...
  int  norm = p_poly->m2flag&(MAT2_CALC_MAP1|MAT2_CALC_MAP2|MAT2_CALC_MAP3|MAT2_CALC_MAP4);
