 ...
 * Editor gui state
 */
#ifndef __SDL_GUI_STATE_H__
#define __SDL_GUI_STATE_H__
  ...
  : virtual public editor_reference
{
  ...
  MESH_MODIFICATOR_ITEM   *p_generator_mesh_modificator_selected;
...
public:
  ...
  void selection_generator_mesh_modificator_set(MESH_MODIFICATOR_ITEM *p_modificator)
  {
    p_generator_mesh_modificator_selected = p_modificator;
  }
  bool is_selected_generator_mesh_modificator(MESH_MODIFICATOR_ITEM *p_modificator)
  {
